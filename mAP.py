...
# GT_PATH = os.path.join(os.getcwd(), 'SeaShip\\val', 'ground_truth')
# DR_PATH = os.path.join(os.getcwd(), 'SeaShip\\val', 'result')
# # if there are no images then no animation can be shown
# IMG_PATH = os.path.join(os.getcwd(), 'SeaShip\\val', 'images')


GT_PATH = os.path.join(os.getcwd(), 'data\\val', 'ground_truth')
DR_PATH = os.path.join(os.getcwd(), 'data\\val', 'result')
IMG_PATH = os.path.join(os.getcwd(), 'data\\val', 'images')
            ...
            if show_animation:
                ...
                if len(ground_truth_img) == 0:
                    ...
                    if os.path.isfile(img_cumulative_path):
                        img_cumulative = cv2.imread(img_cumulative_path).resize(480, 256)
                    else:
                        img_cumulative = img.copy().resize(480, 256)
